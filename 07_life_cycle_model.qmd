...
The stage-structured matrix modelling framework, embedded within the CEMPRA tool, can be represented graphically by a life cycle diagram (@fig-figure28) or a transition matrix. The transition matrix can be represented symbolically with either equations (Table 1) or absolute values (Table 2).

@fig-figure28 shows the sample life cycle profile. @fig-figure27 is represented as a life cycle diagram. In the diagram and input file, we see that there are four main stages (stage_1 to stage_4). stage_1 individuals can become stage_4 individuals after three years in the simulation, but it is also possible for some individuals to spend more than one year in stages 2, 3, and 4 (denoted by the circular loop). We also see that stage_4 individuals are sexually mature and have the capacity to generate new stage_1 individuals. There are also special year 0 (Age-0) events that occur before new stage_1 (Age-1) individuals are secured in the simulation. These events include egg survival (SE) and Age-0 fry survival (S0).

![The life cycle diagram for the demo life cycle profile is shown in @fig-figure27.](assets/images/image040.png){#07_life_cycle_model-07_life_cycle_model-07_life_cycle_model-fig-figure28}
...
::: {#07_life_cycle_model-tbl:transition-matrix}
...
::: {#07_life_cycle_model-tbl:numerical-transition-matrix}
...
![Beverton-Holt function for density-dependent growth](assets/images/image043.png){#07_life_cycle_model-fig-beverton-holt}
...
![Beverton-Holt function for density-dependent growth](assets/images/image044.jpg){#07_life_cycle_model-fig-density-dependent}
...
![Location and stage-specific carrying capacity input data table](assets/images/image045.png){#07_life_cycle_model-fig-location-specific}
...
![Simulation of Steelhead Spawners with stage_1 capacity set to 160,000](assets/images/image047.png){#07_life_cycle_model-fig-steelhead-spawners}
...
![Compensation Ratio CR for life stage i](assets/images/image048.png){#07_life_cycle_model-fig-compensation-ratio}
...
![Influence of compensation ratios on stage-specific survivorship](assets/images/image049.jpg){#07_life_cycle_model-fig-compensation-ratios-effect}
...
![Stable Stage Distributions and Stage-specific Carrying Capacities](assets/images/image050.png){#07_life_cycle_model-fig-stable-stage-distributions}
...
![eps_sd Standard Deviation in Eggs-per-Spawner](assets/images/image051.png){#07_life_cycle_model-fig-eps-sd}
...
![egg_rho: correlation in egg fecundity through time](assets/images/image052.png){#07_life_cycle_model-fig-egg-rho}
...
![M.rho: correlation in survivorship through time](assets/images/image053.png){#07_life_cycle_model-fig-m-rho}
...
![Probability of Catastrophe per Generation](assets/images/image054.png){#07_life_cycle_model-fig-p-cat}
...
![Sample life cycle diagram and periodicity table for Coho Salmon](assets/images/image055.png){#07_life_cycle_model-fig-coho-salmon-lifecycle}
