...
![Example interaction surface for the CEMPRA 2-factor interaction matrix between trout capacity canopy cover and nutrients.](assets/images/image001.png){#fig-figure1}
...
![Example Matrix interaction surface for stressor variables A and B.](assets/images/image002.png){#fig-figure2}
...
![Difference between main effects being included or excluded from 2-factor interaction matrix summary. The Interaction factor for main effects Excluded (X) will be different (in this case lower) than for main effects Included.](assets/images/image003.png){#fig-figure3}
...
![Matrices of different resolutions.](assets/images/image004.png){#fig-figure4}
