...
A working example of all data inputs can be downloaded from a ‘demo’ directory with the CEMPRAShiny project repository: [CEMPRAShiny demo](https://github.com/essatech/CEMPRAShiny/tree/main/data/demo).

Download the repository locally and navigate to the demo folder: .\CEMPRAShiny-main\data\demo:
...
![Main worksheet in the Stressor-Response workbook.](assets/images/image019.jpg){#fig-main-worksheet}
...
![Example of an individual stressor worksheet within the stressor response Excel workbook.](assets/images/image020.png){#fig-individual-stressor}
...
![Example of a stressor magnitude workbook.](assets/images/image021.jpg){#fig-stressor-magnitude}
...
![Example of assigning stressor magnitudes values (stream temperature) to spatial units (locations).](assets/images/image022.png){#fig-stressor-magnitudes-values}
...
![Example of a spatial polygons (locations) file and its associated attribute table with fields HUC_ID and NAME.](assets/images/image023.jpg){#fig-spatial-polygons}
...
![Example life cycles profile CSV file.](assets/images/image024.png){#fig-life-cycles-profile}
