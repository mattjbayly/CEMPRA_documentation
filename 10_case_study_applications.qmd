...
The following example datasets demonstrate different applications of the CEMPRA framework. Each includes the input files needed to run the [Joe Model](03_pathways_endpoints.qmd) and/or the [life cycle model](07_life_cycle_model.qmd) in the [R Shiny application](06_r_shiny_app.qmd). See [Data Inputs](05_data_inputs.qmd) for guidance on preparing your own input files.
...
-   [Habitat Capacities (optional)](/sample_data/athabasca_rbt/habitat_capacities.csv)
_cy
...
## Minimal Simple Working Example (hypothetical)
...
##  {#09_case_study_applications-09_case_study_applications-nicola-basin-salmonids}