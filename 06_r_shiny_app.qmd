...
![Pop-up window for the life cycle model. 1) Input boxes for the number of years and number of replicates in the simulation. 2) The button to run the life cycle model. 3) Plotting window for time series projection plots.](images/image032.png){#fig-figure20} \## Life Cycle Model
