...
![Data structure within the SR library, where the table hierarchy starts at the SR Library Main folder (left) and ends at the references and documentation for individual stressor-response functions (right).](/assets/images/image056.png){#08_stressor_response_library-fig-stressor-response-schema}
...
![Use of the SR library in the CEMPRA (Joe Model). The SR library contains individual worksheets which can be selected to create a custom SR workbook for use in the model.](/assets/images/image057.jpg){#08_stressor_response_library-fig-sr-library-use}
